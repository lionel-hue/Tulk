  ...
  const handleCreatePost = async () => {
    if (!newPostDescription.trim() && !postImage) {
      setModal({
        ...
        title: 'Attention',
        message:
          'Veuillez écrire quelque chose ou ajouter une image avant de poster'
      })
      return
    }
          ...
          <div className='stats-grid'>
            <div className='stat-item'>
              ...
              <div className='stat-value'>
                {posts.filter(p => p.is_owner).length}
              </div>
            </div>
            <div className='stat-item'>
            ...
            <div className='stat-item'>
              ...
              <div className='stat-value'>
                {posts
                  .filter(p => p.is_owner)
                  .reduce((sum, post) => sum + post.likes_count, 0)}
              </div>
            </div>
            <div className='stat-item'>
              ...
              <div className='stat-value'>
                {posts
                  .filter(p => p.is_owner)
                  .reduce((sum, post) => sum + post.comments_count, 0)}
              </div>
            </div>
          </div>
        </div>
      ...
      <div className='dashboard-container'>
        ...
        <div className='text-center py-8'>
          ...
          <p className='text-gray-400'>
            Tableau de bord réservé aux{' '}
            {user.role === 'admin' ? 'administrateurs' : 'modérateurs'}
          </p>
        </div>
      </div>
    </div>
